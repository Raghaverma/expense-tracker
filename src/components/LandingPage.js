  ...
  const features = [
    {
      ...
      description: 'Track your daily expenses and income with an intuitive interface'
    },
    {
      icon: '🎯',
      title: 'Budget Goals',
    ...
    },
    {
      ...
      description: 'Organize transactions with customizable categories and tags'
    },
    {
      icon: '📱',
    ...
    <div className="landing-page">
      ...
      <section id="features" className="features-section">
        ...
        <p className="section-subtitle">
          Our expense tracker comes packed with powerful features to help you stay
          on top of your financial game
        </p>
